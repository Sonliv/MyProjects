...
function Social() {
    return(   
        <div className="footer-social footer-show-690"> {/* Added the class name for responsiveness */}
                ...
                <div className="footer-wrapper">
                    <div className="footer-nav">
                        ...
                        <div className="footer-info">
                            ...
                            <Social /> {/* Integrated the Social component */}
                        </div>
                    </div>
                    <div className="footer-social footer-adaptive">
                        <div className="footer-icons">
                            <a href="#"><img src={Facebook} alt="" /></a>
                            <a href="#"><img src={Inst} alt="" /></a>
                            <a href="#"><img src={Youtube} alt="" /></a>
